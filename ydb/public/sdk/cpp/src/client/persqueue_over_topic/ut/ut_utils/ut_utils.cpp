...
TSimpleWriteSessionTestAdapter::TSimpleWriteSessionTestAdapter(ISimpleBlockingWriteSession* session)
    : Session(session)
{}

ui64 TSimpleWriteSessionTestAdapter::GetAcquiredMessagesCount() const {
    return ::NYdb::NPersQueue::NOverTopic::GetAcquiredMessagesCountForTest(Session);
}
