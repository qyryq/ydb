...
#include <ydb/public/sdk/cpp/src/client/persqueue_over_topic/ut/ut_utils/test_utils.h>
#include <ydb/public/sdk/cpp/src/client/persqueue_over_topic/ut/ut_utils/sdk_test_setup.h>
#include <ydb/public/sdk/cpp/src/client/persqueue_over_topic/include/aliases.h>
#include <ydb/public/sdk/cpp/src/client/persqueue_over_topic/include/write_session.h>
#include <ydb/public/sdk/cpp/src/client/persqueue_over_topic/impl/write_session_adapter.h>
#include <ydb/public/sdk/cpp/src/client/persqueue_over_topic/include/write_session.h>
...
public:
    ...
    // Override base class WriteToTopic to use GetPersQueueClient() which has the properly
    // configured driver with database="/Root" for FederatedTopic fallback to work correctly.
    void WriteToTopic(const TVector<TString>& data, bool compress = true) {
        ...
        auto writer = GetPersQueueClient().CreateSimpleBlockingWriteSession(settings);
...
public:
    TSimpleWriteSessionTestAdapter(ISimpleBlockingWriteSession* session);
    ui64 GetAcquiredMessagesCount() const;

private:
    ISimpleBlockingWriteSession* Session;
};
