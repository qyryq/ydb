...
Y_UNIT_TEST_SUITE(RetryPolicy) {
    ...
    // DISABLED: This test relies on PersQueue v1 cluster discovery which the
    // persqueue_over_topic wrapper doesn't support (uses FederatedTopic discovery instead)
#if 0
